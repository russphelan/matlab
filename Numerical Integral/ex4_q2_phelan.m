...
%By: Russell J Phelan 10/30/14 for Computational Physics 281 at UMass
%Amherst

%uses functions for executing integration rules found in the same folder. 
